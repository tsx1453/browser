...
public class CompleteAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item.getType()==STARTSITE_ITEM) {  //Item from start page
            holder.iconView.setImageResource(R.drawable.libbrs_icon_web);
        } else if (item.getType()==HISTORY_ITEM){  //Item from history
            holder.iconView.setImageResource(R.drawable.libbrs_icon_history);
        } else if (item.getType()==BOOKMARK_ITEM) holder.iconView.setImageResource(R.drawable.libbrs_icon_bookmark);  //Item from bookmarks
