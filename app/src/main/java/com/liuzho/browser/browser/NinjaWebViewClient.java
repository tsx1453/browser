...
import com.liuzho.browser.utils.FaviconLoadHelper;
...
public class NinjaWebViewClient extends WebViewClient {
    ...
    private final BrowserPref browserPref;
    ...
    public NinjaWebViewClient(NinjaWebView ninjaWebView) {
        ...
        this.browserPref = BrowserPref.getInstance();
    ...
    public void onPageFinished(WebView view, String url) {
        ...
        if (browserPref.jsPageFinishedSwitch()) {
            view.evaluateJavascript(browserPref.jsPageFinished(), null);
        }
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
        ...
        if (browserPref.jsPageStartedSwitch()) {
            view.evaluateJavascript(browserPref.jsPageStarted(), null);
        }
    ...
    public void onLoadResource(WebView view, String url) {
        ...
        if (browserPref.jsPageLoadResourceSwitch()) {
            view.evaluateJavascript(browserPref.jsPageLoadResource(), null);
        }
    ...
    private boolean handleUri(final Uri uri) {
        if (ninjaWebView.isBackPressed) {
            ...
            if (url.startsWith("intent:")) {
                ...
                Intent chooser = Intent.createChooser(intent, context.getString(R.string.libbrs_menu_open_with));
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
        ...
        if (BrowserConstant.CUSTOM_FAVICON_HOST.equals(request.getUrl().getScheme())) {
    ...
    public void onFormResubmission(WebView view, @NonNull final Message doNotResend, final Message resend) {
        ...
        builder.setMessage(R.string.libbrs_dialog_content_resubmission);
        builder.setPositiveButton(android.R.string.ok, (dialog, whichButton) -> resend.sendToTarget());
    ...
    public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
        ...
        String text = message + " - " + context.getString(R.string.libbrs_dialog_content_ssl_error);
        MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(context);
        builder.setIcon(R.drawable.libbrs_icon_alert);
        builder.setTitle(R.string.libbrs_app_warning);
        builder.setMessage(text);
        builder.setPositiveButton(android.R.string.ok, (dialog, whichButton) -> handler.proceed());
        builder.setNegativeButton(android.R.string.cancel, (dialog, whichButton) -> dialog.cancel());
        AlertDialog dialog = builder.create();
        dialog.show();
    ...
    public void onReceivedHttpAuthRequest(WebView view, @NonNull final HttpAuthHandler handler, String host, String realm) {
        ...
        MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(context);
        View dialogView = View.inflate(context, R.layout.libbrs_dialog_edit_title, null);
